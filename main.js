...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  var UUIDtestBtn = document.getElementById('test-uuid');
  //var autoTestBtn = require('UUID');
...
//--
  ...
  expected_output[2] = '0000180d-0000-1000-8000-00805f9b34fb'; // heart_rate
...
// Syntax error Test
  ...
  UUIDtestBtn.onclick = function changeUUIDPage() {
    ...
    for (var i = 0; i < expected_output.length; i++) {
      ...
      switch(i) {
        ...
        case 1:
          ...
          break;
        case 2:
          check(BluetoothUUID.getService, 'heart_rate', expected_output[i]);
          break;
        case 3:
        ...
        case 7:
          ...
          break;
        case 8:
          check(BluetoothUUID.getService, '0000abcd-0000-1000-8000-00805f9b34fb', expected_output[i]);
          break;
        case 9:
          check(BluetoothUUID.getService, '0000ABCD-0000-1000-8000-00805f9b34fb', expected_output[i]);
          break;
